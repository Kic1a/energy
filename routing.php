...
Utils::addRoute('deviceAdd',    'deviceEditCtrl',     ['user','admin']);
Utils::addRoute('deviceEdit',   'deviceEditCtrl',     ['user','admin']);
Utils::addRoute('deviceSave', 'deviceEditCtrl', ['user','admin']);
Utils::addRoute('deviceDelete', 'deviceCtrl',     ['user','admin']);
Utils::addRoute('energyEdit',   'energyEditCtrl', ['user','admin']);
Utils::addRoute('energySave',   'energyEditCtrl', ['user','admin']);
Utils::addRoute('energySave',    'energyEditCtrl',    ['user','admin']);
Utils::addRoute('energyDelete', 'deviceCtrl',     ['user','admin']);
